...
@Name("Decrypt String")
@Description("This expression allows you to decrypt a string with the AES system. A key is necessary.")
@Examples({"on chat:",
...
@Since("1.2.0")
public class ExprDecryptString extends SimpleExpression<String> {

    static {
        Skript.registerExpression(ExprDecryptString.class, String.class, ExpressionType.SIMPLE, "[aes] decrypt %string% [with] key %string%");
    }
    ...
    protected String[] get(final @NotNull Event e) {
        ...
        return new String[] {encryption.decrypt(this.message.getSingle(e))};
    }
    ...
    public @NotNull String toString(final @Nullable Event e, final boolean debug) {
        return "decrypt a " + this.message.toString(e, debug) + "message with a " + this.key.toString(e, debug) + " key";
    }
